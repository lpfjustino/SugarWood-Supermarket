...
public class CSVManager {
	...
	// Função utilizada para persistir em um arquivo CSV uma instância de 
        // uma classe qualquer que seja um AbstractModel
	...
	public static <T extends AbstractModel> void persist (T model)  {
        ...
        // Factory utilizada para que, a partir de uma classe qualquerque seja
        // um AbstractModel, crie-se instâncias de objetos desta a partir de 
        // um arquivo CSV
